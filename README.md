 Memory Match: A Game 
I built this project to give kids a fun, simple way to work on their focus and memory. It’s a classic card-matching game.
...
Why I built this
I’ve always loved how simple games can be the best teachers. I wanted to see if I could take a basic concept—memory—and build the entire logic from scratch. I made this specifically with young children in mind, making sure the interface was clean and the "win" . Plus, I wanted to challenge myself to handle the logic for a 2-player turn-based system, which was a fun puzzle to solve!

The Tech Stack
I kept things lean and efficient for this one:

HTML & CSS: I used these for the layout and those snappy card-flip animations.
